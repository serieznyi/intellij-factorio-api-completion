package io.serieznyi.intellij.factorioapicompletion.core.parser.api.writer;

import io.serieznyi.intellij.factorioapicompletion.core.parser.api.data.*;
    ...
    private void writeConcepts(List<Concept> concepts) throws IOException {
        ...
        for (Concept concept : concepts) {
            if (concept.type() instanceof ValueType.Table) {
                ...
                log.warn("Unknown concept type: " + concept.type().getNativeName());
            }
        }
    }
